...
export const aboutSections: AboutSection[] = [
  {
    ...
    title: 'The Concept',
    content: [
      'Voyage Permanent is an ongoing, multi-city art and photography exhibition that explores themes of exploitation, memory, displacement, and the invisible threads connecting communities across geographical and temporal boundaries.',
      'Unlike traditional exhibitions, Voyage Permanent is not a static event. It is a living archive that grows, transforms, and adapts as it moves through different cities, engaging with local communities and incorporating their stories into the broader narrative.',
